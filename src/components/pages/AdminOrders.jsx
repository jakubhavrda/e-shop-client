      ...
      <table className="table my-5">
        ...
        <tbody>
          {orders.map((order, index) => (
            <tr
              key={index}
              className={order.complete ? "border-success" : "border-danger"}
            >
              ...
              <td>
                <a
                  href={"/order/" + order.user_id + "/" + order.order_id}
      ...
      >
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">Do you want to complete the order!</div>
